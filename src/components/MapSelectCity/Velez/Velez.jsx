    ...
    <div className="w-full h-full">
      ...
      >
        <g>
          ...
          />
          <path
            fill={getColorByCarencias('EL GAITAL', municipio.toUpperCase())}
            data-tooltip-id="my-tooltip" 
          ...
          />
          <path
            fill={getColorByCarencias('ABSINIA', municipio.toUpperCase())}
            data-tooltip-id="my-tooltip" 
          ...
          />
          <path
            fill={getColorByCarencias('LA HELIADA', municipio.toUpperCase())}
            data-tooltip-id="my-tooltip" 
          ...
          />
          <path
            fill={getColorByCarencias('GUALILO', municipio.toUpperCase())}
            data-tooltip-id="my-tooltip" 
          ...
          />
          <path
            fill={getColorByCarencias('DOCTRINA PORTACHUELO', municipio.toUpperCase())}
            data-tooltip-id="my-tooltip" 
