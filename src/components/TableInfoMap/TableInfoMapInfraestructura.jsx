...
const TableInfoMapInfraestructura = ({departamento, municipio, titleDb, onMarkerClick}) => {
  ...
  const filteredData = dataFactor.filter(
    (item) =>
      ...
      item.FACTOR_SIMPLIFICADO.toLowerCase() === 'infraestructura'
  );
...
export default TableInfoMapInfraestructura