...
const TableInfoMapPolitico = ({departamento, municipio, titleDb, onMarkerClick}) => {
  ...
  const filteredData = dataFactor.filter(
    (item) =>
      ...
      item.FACTOR_SIMPLIFICADO.toLowerCase() === 'politico institucional'
  );
...
export default TableInfoMapPolitico