...
const TableInfoMapSocial = ({departamento, municipio, titleDb, onMarkerClick}) => {
  ...
  const filteredData = dataFactor.filter(
    (item) =>
      ...
      item.FACTOR_SIMPLIFICADO.toLowerCase() === 'social y cultural'
  );
...
export default TableInfoMapSocial