    ...
    <div className='w-full h-full p-5 lg:p-20 pt-[72.5px] lg:pt-[82.5px] GraphicsHome'>
      <div className="lg:flex justify-between">
        <div className="title mb-8 lg:mb-12 flex items-center gap-5">
          ...
          <div className="homeMap lg:flex items-end gap-5">
        ...
        <div className="btn-action hidden lg:block">
          <Link to={'/departamento/santander'} className='btn btn-link color-green-800'>
      ...
      <div className="lg:flex gap-20">
        <div className="card w-full bg-base-100 shadow-xl mb-5 lg:mb-0">
          <GraphicsEconomico />
