      ...
      <div className="card w-full bg-base-100 shadow-md p-0">
        <div className="card-body p-5">
          ...
          <div className="inputGroup  mb-1">
            <input type="checkbox" name="item" id={`item1${itemVeredafilter}`} className='hidden' selected={selected}/>
          ...
          <div className="inputGroup  mb-1">
            <input type="checkbox" name="item" id={`item2${itemVeredafilter}`} className='hidden' selected={selected}/>
          ...
          <div className="inputGroup  mb-1">
            ...
            <label htmlFor={`item3${itemVeredafilter}`} selected={selected} >
              <div className="content">
                <div className="flex gap-3">
          ...
          <div className="inputGroup  mb-1">
            ...
            <label htmlFor={`item4${itemVeredafilter}`} selected={selected} >
              <div className="content">
                <div className="flex gap-3">
          ...
          <div className="inputGroup  mb-1">
            ...
            <label htmlFor={`item5${itemVeredafilter}`} selected={selected} >
              <div className="content">
                <div className="flex gap-3">
                  <div className="colorItem color1">
