  ...
  return (
    <div>
      ...
      >
        ...
        <path
          className="cls-1"
          d="M14.6,6.84c0,.13,0,.26,0,.39,0,.05-.01.07-.07.07-.26,0-.52,0-.78,0-.06,0-.07-.02-.07-.07,0-.26,0-.52,0-.78,0-.06.02-.07.08-.07.26,0,.51,0,.77,0,.06,0,.08.02.08.08,0,.13,0,.25,0,.38Z"
        />
        <path
          className="cls-1"
          d="M23.72,6.85c0,.13,0,.25,0,.38,0,.05-.01.08-.07.08-.26,0-.52,0-.78,0-.06,0-.07-.02-.07-.08,0-.26,0-.51,0-.77,0-.05.01-.08.07-.08.26,0,.52,0,.78,0,.06,0,.07.02.07.08,0,.13,0,.26,0,.39Z"
        />
      </svg>
    </div>
  )
