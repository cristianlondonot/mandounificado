...
const TableInfoMapAmbientalVereda = ({departamento, municipio, titleDb, onMarkerClick, vereda}) => {
  ...
  const filteredData = dataFactor.filter(
    (item) =>
      ...
      (item.FACTOR_SIMPLIFICADO.toLowerCase() === 'ambiental' && item.NOMBRE.toLowerCase() === veredaFormatted)
  );
...
export default TableInfoMapAmbientalVereda