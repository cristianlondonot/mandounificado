...
const TableInfoMapPoliticoVereda = ({departamento, municipio, titleDb, onMarkerClick, vereda}) => {
  ...
  const filteredData = dataFactor.filter(
    (item) =>
      ...
      (item.FACTOR_SIMPLIFICADO.toLowerCase() === 'politico institucional' && item.NOMBRE.toLowerCase() === veredaFormatted)
  );
...
export default TableInfoMapPoliticoVereda