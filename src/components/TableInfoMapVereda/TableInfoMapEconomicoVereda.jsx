...
const TableInfoMapEconomico = ({departamento, municipio, titleDb, onMarkerClick, vereda}) => {
  ...
  const filteredData = dataFactor.filter(
    (item) =>
      ...
      (item.FACTOR_SIMPLIFICADO.toLowerCase() === 'economico' && item.NOMBRE.toLowerCase() === veredaFormatted)
  );
...
export default TableInfoMapEconomico