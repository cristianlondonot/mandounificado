...
const TableInfoMapSocialVereda = ({departamento, municipio, titleDb, onMarkerClick, vereda}) => {
  ...
  const filteredData = dataFactor.filter(
    (item) =>
      ...
      (item.FACTOR_SIMPLIFICADO.toLowerCase() === 'social y cultural' && item.NOMBRE.toLowerCase() === veredaFormatted)
  );
...
export default TableInfoMapSocialVereda