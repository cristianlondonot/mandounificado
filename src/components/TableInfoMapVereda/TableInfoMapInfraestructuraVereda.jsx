...
const TableInfoMapInfraestructuraVereda = ({departamento, municipio, titleDb, onMarkerClick, vereda}) => {
  ...
  const filteredData = dataFactor.filter(
    (item) =>
      ...
      (item.FACTOR_SIMPLIFICADO.toLowerCase() === 'infraestructura' && item.NOMBRE.toLowerCase() === veredaFormatted)
  );
...
export default TableInfoMapInfraestructuraVereda