  ...
  return (
    <div className='w-full h-full p-10'>
      <div className="formTitle mb-12 flex items-center gap-5">
        ...
        <h2 className="text-5xl font-bold">Importar encuesta masiva </h2>
      </div>
      <div className="content">
        ...
        <ul className='list-decimal ps-10'>
          <li className='mb-5'>
            ...
            <ul className='list-disc ps-10'>
              <li>Busca en tu equipo el archivo de datos en formato Excel con tus encuestas.</li>
        ...
        <p className='mt-10'>¡Así de simple! Olvídate de agregar encuestas una a una y disfruta de una experiencia de usuario más eficiente.</p>
        ...
        <div className="btn-action flex justify-center">
          <button className="  bg-green-800 hover:bg-green-700 btn w-96 mt-9 text-slate-50">
            <svg className="w-6 h-6 text-slate-50 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
